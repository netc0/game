...
//}
//
//func (this *Example) Test(info netco.RPCGateRequest, reply *int) error{
//	log.Println("call test", string(info.Data))
//	var response netco.RPCGateResponse
...
//				var data netco.RPCGatePush
//				data.ClientId = info.ClientId
//				data.Data = netco.BuildPushPacket("game.OnPush", []byte(fmt.Sprintf("推送消息 %v", count)))
//
//				var r int
...
//}
//var msgId int = 100
//func (this *Example) Login(info netco.RPCGateRequest, reply *int) error{
...
//
//// 关闭连接
//func (this *Example) OnSessionClose(info netco.RPCMessage, reply *int) error{
